		...
		<div class="container">
			...
			<div class="section-title margin-bottom-40px">
				<div class="row justify-content-center">
					<div class="col-lg-7">
						<div class="icon text-main-color"> L1</div>
						<div class="h2">ESTI</div>
					</div>
				</div>
			</div>
			<!-- // End Title -->
			...
			<div class="row">
				...
				<div class="col-lg-3 col-md-6">
					<div class="team layout-2">
						<div class="img-team">
							<img src="../public/img/ld.JPG" alt="">
						</div>
						<div class="padding-20px">
							<h3>RASENDRANIRINA Manankoraisina Landry.D</h3>
							<div class="jop">Integrateur Web</div>
				...
				<div class="col-lg-3 col-md-6">
					<div class="team layout-2">
						<div class="img-team">
							<img src="../public/img/gae.JPG" alt="">
						</div>
						<div class="padding-20px">
							<h3>BAKARY Gaetan Jonathan</h3>
							<div class="jop">Administrateur Serveur</div>
							<ul class="social-list">
								<li><a class="facebook" href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
								<li><a class="linkedin" href="#"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>
								<li><a class="google" href="#"><i class="fa fa-google-plus" aria-hidden="true"></i></a></li>
				...
				<div class="col-lg-3 col-md-6">
					<div class="team layout-2">
						<div class="img-team">
							<img src="../public/img/merv.JPG" alt="">
						</div>
						<div class="padding-20px">
							<h3>TSIMAGNEKY Merveilleuse Mboahazy Fitia</h3>
							<div class="jop">Dévéloppeur Web</div>
							<ul class="social-list">
								<li><a class="facebook" href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
								<li><a class="linkedin" href="#"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>
								<li><a class="google" href="#"><i class="fa fa-google-plus" aria-hidden="true"></i></a></li>
				...
				<div class="col-lg-3 col-md-6">
					<div class="team layout-2">
						<div class="img-team">
							<img src="../public/img/off.jpg" alt="">
						</div>
						<div class="padding-20px">
							<h3>BIENVENU Jean Offman</h3>
							<div class="jop">Mpijery X</div>
							<ul class="social-list">
								<li><a class="facebook" href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
								<li><a class="linkedin" href="#"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>
								<li><a class="google" href="#"><i class="fa fa-google-plus" aria-hidden="true"></i></a></li>
				...
				<div class="ntsoa">
				<div class="col-lg-4.1 col-md-6">
						<div class="team layout-2">
							<div class="img-team">
								<img src="../public/img/nn.JPG" alt="">
							</div>
							<div class="padding-20px">
								<h3>MIHAINGOHERILANTO Manambintsoa</h3>
								<div class="jop">Développeur PHP</div>
								<ul class="social-list">
									<li><a class="facebook" href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
									<li><a class="linkedin" href="#"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>
									<li><a class="google" href="#"><i class="fa fa-google-plus" aria-hidden="true"></i></a></li>
